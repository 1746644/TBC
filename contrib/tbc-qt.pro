...
RESOURCES += src/qt/tbc.qrc src/qt/tbc_locale.qrc

TRANSLATIONS += src/qt/locale/tbc_bg.ts \
                src/qt/locale/tbc_de.ts \
                src/qt/locale/tbc_en.ts \
                src/qt/locale/tbc_es.ts \
                src/qt/locale/tbc_fi.ts \
                src/qt/locale/tbc_fr.ts \
                src/qt/locale/tbc_it.ts \
                src/qt/locale/tbc_ja.ts \
                src/qt/locale/tbc_pl.ts \
                src/qt/locale/tbc_pt.ts \
                src/qt/locale/tbc_ru.ts \
                src/qt/locale/tbc_sk.ts \
                src/qt/locale/tbc_sv.ts \
                src/qt/locale/tbc_vi.ts \
                src/qt/locale/tbc_zh_CN.ts \
                src/qt/locale/tbc_zh_TW.ts
