...
In order to support loading of multiple wallets in tbc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tbc.cpp.
...
Changes to tbc.cpp
----------------------
tbc.cpp is the entry point into tbc-qt, and as such, will require some minor modifications to provide hooks for
