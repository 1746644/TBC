...
TBC Core version *version* is now available from:
...
TBC Core is extensively tested on multiple operating systems using
...
TBC Core should also work on most other Unix-like systems but is not
...
This allows running tbcd without having to do any manual configuration.
