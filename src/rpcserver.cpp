...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TBC features */
        {"tbc", "masternode", &masternode, true, true, false},
        {"tbc", "listmasternodes", &listmasternodes, true, true, false},
        {"tbc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tbc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tbc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tbc", "masternodedebug", &masternodedebug, true, true, false},
        {"tbc", "startmasternode", &startmasternode, true, true, false},
        {"tbc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tbc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tbc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tbc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tbc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tbc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tbc", "mnbudget", &mnbudget, true, true, false},
        {"tbc", "preparebudget", &preparebudget, true, true, false},
        {"tbc", "submitbudget", &submitbudget, true, true, false},
        {"tbc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tbc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tbc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tbc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tbc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tbc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tbc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tbc", "checkbudgets", &checkbudgets, true, true, false},
        {"tbc", "mnsync", &mnsync, true, true, false},
        {"tbc", "spork", &spork, true, true, false},
        {"tbc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"tbc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
        ...
        {"wallet", "getunspendablebalance", &getunspendablebalance, false, false, true},
        ...
        {"wallet", "listtransactionsex", &listtransactionsex, false, false, true},
        ...
        {"wallet", "sendmanyex", &sendmanyex, false, false, true},
		...
		{"zerocoin", "getzerocoinlist", &getzerocoinlist, false, false, false}
...
{
    return "> tbc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:62223/\n";
}
