 ...
 */
    ...
    typeWidget->addItem(tr("Received TBC from zTBC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zTBC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zTbc));
