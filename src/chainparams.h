 ...
 * TBC system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::vector<unsigned char>& PreminePubKey() const { return strPreminePubKey; }
...
protected:
    ...
    std::vector<unsigned char> strPreminePubKey;
};
