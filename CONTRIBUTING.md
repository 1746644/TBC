Contributing to TBC Core
============================

The TBC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TBC Core project, and is not to be
confused with overall TBC Network Protocol consensus changes.

Whether a pull request is merged into TBC Core rests with the project merge
...
Patches that change TBC consensus rules are considerably more involved than
...
Where a patch set proposes to change the TBC consensus, it must have been
...
The project leader is the release manager for each TBC Core release.
