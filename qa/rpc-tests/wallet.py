...
#   c) node1 mines 32 blocks, so now node 0 has 60001tbc, node 1 has 4250tbc, node2 has none.
#   d) node0 sends 601 tbc to node2, in two transactions (301 tbc, then 300 tbc).
